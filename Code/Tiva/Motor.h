...
#define M2_INL_PIN_A GPIO_PIN_1
#define M2_INL_PERIPH_B SYSCTL_PERIPH_GPIOD
#define M2_INL_PORT_B GPIO_PORTD_BASE
#define M2_INL_PIN_B GPIO_PIN_5
#define M2_INL_PERIPH_C SYSCTL_PERIPH_GPIOD
#define M2_INL_PORT_C GPIO_PORTD_BASE
#define M2_INL_PIN_C GPIO_PIN_6
