...
\begin{DoxyCompactList}\small\item\em Reads the motor 2\textquotesingle{}s speed in terms of revolutions/sec from the encoder. \end{DoxyCompactList}\end{DoxyCompactItemize}
